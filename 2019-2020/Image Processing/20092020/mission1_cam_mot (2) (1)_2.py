...
while True:
    ...
    a = round(circle[2])
    b = round(center[0])
#     for t in range(0,circle[2]):
#         t += 1
#     for d in range(0,circle[0]):
#         d += 1
#     print(type(a),a)
#     print(type(b),b)
#     print(type(t),t)
...
""" 
    if circle is None:
        ...
        #################### Güdümleme
        print("Güdümleme")
        ##########gudumleme(circle[2], center[0]) # circle 2 is the radius, center 0 is the width of the screen
