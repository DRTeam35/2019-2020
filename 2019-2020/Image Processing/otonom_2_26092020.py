...
def motor_r_yengec(p):  # sağ/sol motorlar
    ...
    fark = p - 311
    pwm2 = 311 - fark
    pwm.set_pwm(4, 0, pwm2 - 0)  # gerekirse 0'ı 5 yap
    pwm.set_pwm(5, 0, p + 0)  # gerekirse 0'ı 5 yap
...
def motor_l_yengec(p):  # sağ/sol motorlar
    ...
    fark = p - 311
    pwm2 = 311 - fark
    pwm.set_pwm(4, 0, p + 0)  # gerekirse 0'ı 5 yap
    pwm.set_pwm(5, 0, pwm2 - 0)  # gerekirse 0'ı 5 yap
...
def start_1():
    print("start_1 calisiyor")
    deneme_1()


def start_2():
    print("start_2 calisiyor")
    deneme_2()
...
while k != 3: # Allahın hakkı üçtür
    ...
    motor_ud(330)  # biraz yukarı çıkar
    time.sleep(0.5)
    motor_stp()
...
for i in range(0, 6):  # gitmiş oldu, havuzu ortaladı
    motor_fr(330)
    time.sleep(3)
    motor_stp()
